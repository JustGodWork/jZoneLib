...
---@overload fun(id: number, eMarkerType: eMarkerType, position: vector3, direction: vector3, rotation: vector3, scale: Scale, color: Color, bobUpAndDown: boolean, faceCamera: boolean, rotate: boolean, textureDict: string, textureName: string, drawOnEnts: boolean): Marker
